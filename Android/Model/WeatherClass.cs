...
namespace Weather.Model
{
    ...
    {
        public RootObjectDailyForecast ObjRootObjectDailyForecast { get; set; }
        public RootObjectHourlyForecast ObjRootObjectHourlyForecast { get; set; }
    ...
    public class RootObjectDailyForecast
    {
